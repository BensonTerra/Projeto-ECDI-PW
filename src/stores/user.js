...
export const useUserStore = defineStore("user", {
  state: () => ({
    ...
    user: null,
    users: [
      {id: 1, email: "simao@gmail.com", username: "simao", password: "12345", isAdmin: false, isBlocked: false, avatar: '../src/assets/avatar/defaultAvatar.jpg', favoriteAirports:[], favoriteCompanies:[], visitedStates: [] },
      {id: 2, email: "luisa@gmail.com", username: "luisa", password: "12345", isAdmin: false, isBlocked: false, avatar: '../src/assets/avatar/defaultAvatar.jpg',favoriteAirports:[], favoriteCompanies:[], visitedStates: []  },
      {id: 3, email: "nelson@gmail.com", username: "nelson", password: "12345", isAdmin: false, isBlocked: false, avatar: '../src/assets/avatar/defaultAvatar.jpg', favoriteAirports:[], favoriteCompanies:[], visitedStates: []  },
      {id: 4, email: "admin@gmail.com", username: "admin", password: "admin", isAdmin: true, isBlocked: false, avatar: '../src/assets/avatar/avatar4.png', favoriteAirports:[], favoriteCompanies:[], visitedStates: []  },
      {id: 5, email: "admin2@gmail.com", username: "admin2", password: "admin2", isAdmin: true, isBlocked: false, avatar: '../src/assets/avatar/avatar4.png', favoriteAirports:[], favoriteCompanies:[], visitedStates: []  },
      {id: 6, email: "blocked@gmail.com", username: "blocked", password: "blocked", isAdmin: false, isBlocked: true, avatar: '../src/assets/avatar/defaultAvatar.jpg', favoriteAirports:[], favoriteCompanies:[], visitedStates: []  },
    ],
    airports: [
    ...
    states:[
      ...
      {id:5, 
        ...
        curiositieTitle: 'Palácio Rio Branco',
        curiositiesPlace: 'Acre- Rio Branco', 
        curiositieDesc: 'É a sede do governo do estado do Acre, construido em 1930, o edificio foi um marco de modernidade numa epóca onde as edificações eram todas de madeira. Na frente do complexo arquitetónico se encontra o Obelisco do Acre que foi construido em homenagem aos heróis da Revolução Acreana.', 
        curiositiesSrc:'src/assets/CuriositiesImgs/Acre.jpg'
      },
      ...
      {id:6, 
        ...
        x:90, 
        y:170,
        src:"/src/assets/pins/Rondonia.png",  
        ...
        curiositieTitle: 'AS Três Marias',
        curiositiesPlace: 'Rondônia- Porto Velho', 
        curiositieDesc: "As caixas d'água foram inauguradas em 1912, projetadas e construídas pela Chicago Bridge & Iron Works, de Chicago, e vieram dos Estados Unidos para servirem as obras de Ferro Maderia Mamoré. Têem a capacidade de 200.000 litros cada e serviram para abastecer a cidade até o ano 1957, funcionando por ação da gravidade.", 
        curiositiesSrc:'/src/assets/CuriositiesImgs/Rondonia.jpg'
      },
      ...
      {id:13, 
        ...
        x:340, 
        y:310,
        src:"/src/assets/pins/RiodeJaneiro.png",  
        path:"m 363.1,338.2328 c -0.0989,-0.51798 -0.82693,-1.16771 -0.15989,-1.52532 1.41996,-1.35823 2.83993,-2.71645 4.25989,-4.07468 2.2642,-0.71602 4.79084,-1.08547 6.54236,-2.83667 0.8029,-1.10993 0.22161,-2.9683 0.65536,-4.37163 0.25563,-1.46596 1.89871,-3.55233 1.11345,-4.76511 -2.65501,-0.33392 -4.3289,-0.72891 -6.46223,-1.06224 -0.73333,-1.4 -1.84008,-3.79576 -2.57341,-5.19576 -1.13938,1.07281 -1.89546,3.86104 -2.64428,5.22203 -0.99781,2.1121 -1.21129,4.72686 -2.83125,6.40938 -2.10933,2.1908 -5.20042,3.4986 -8.2,4 -2.08387,0.34833 -4.18551,-0.95315 -6.29077,-0.77508 -3.67506,0.31085 -6.64821,2.0917 -10.59824,3.17834 -0.26524,0.21021 -4.06632,1.16243 -3.04305,0.97227 2.8224,1.38251 3.92047,1.68102 4.27851,3.48532 0.43577,2.196 -2.5134,4.51542 -3.19301,5.90894 0.62984,0.95526 3.90098,-2.15861 4.69564,-2.5089 0.50603,-0.28559 3.20451,-1.38137 3.6768,-0.77517 1.60225,1.25939 4.33171,0.16742 6.27411,0.11428 0.53333,-1 0.53078,-2.62421 1.6,-3 0.95799,-0.33669 1.86667,0.8 2.8,1.2 -0.33333,0.53333 -0.66667,1.06667 -1,1.6 3.56206,0.19651 7.13314,0.52715 10.7,0.3 0.79269,-0.0892 0.72066,-0.60731 0.4717,-1.21318 -0.0239,-0.0956 -0.0478,-0.19121 -0.0717,-0.28682 z",
        curiositieTitle: 'Cristo Redentor',
        curiositiesPlace: 'Rio de Janeiro - Rio de Janeiro', 
        curiositieDesc: 'A escultura que representa Jesus Cristo localizada no topo do Morro do Corcovado a 709 metros acima no nível do mar na capital do estado (Rio de Janeiro).É feita de concreto e pedra-sabão e tem 30 metros de altura (uma das maiores estátuas do mundo) sem contar 8 metros de pedestal. Seus braços se esticam por 28 metros de largura e nosso pequeno Cristo pesa apenas 1145 tonaladas.', 
        curiositiesSrc:'src/assets/CuriositiesImgs/RioDeJaneiro.jpg'
      },
      ...
      {id:20, 
        ...
        x:320, 
        y:180, 
        src:"/src/assets/pins/bahiaPin.png",  
        ...
        curiositieTitle: 'Elevador Lacerda',
        curiositiesPlace: 'Bahia - Salvador', 
        curiositieDesc: 'É o primeiro elevador urbano do mundo. Em 8 de dezembro de 1873, quando a torre foi inaugurada tratava-se do elevador mais alto do mundo com 63 metros de altura. A estrutura atual tem 70 metros de altura, e é um transporte público que leva pessoas entre a Praça Cairu, na cidade baixa, e a Praça Tomé de Sousa, na cidade alta.', 
        curiositiesSrc:'/src/assets/CuriositiesImgs/Bahia.png'
      },
      ...
      {id:21, 
        ...
        curiositieTitle: 'Centro dragão do Mar de Arte e Cultura',
        curiositiesPlace: 'Ceara - Fortaleza', 
        curiositieDesc: 'Um dos maiores centros culturais do Brasil com 30 mil metros quadrados de área dedicada à arte e à cultura, com atrações como o Museu da Cultura Cearense, Museu de Arte Contemporânea, Planetário Rubens de Azevedo, Teatro Dragão do Mar, Salas de cinema do dragão, Anfiteatro Sérgio mota, Espaço Rogaciano Leite FIlho, Biblioteca Leonilson, Auditório, Multigalerias e espaços para exposições itinerantes e Praça verde, que abriga mais de 4 mil pessoas e também grandes shows nacionais e internacionais. ', 
        curiositiesSrc:'src/assets/CuriositiesImgs/Ceara.jpg'
      },
      ...
      {id:24, 
        ...
        x:390, 
        y:150, 
        src:"/src/assets/pins/Pernambuco.png",  
        ...
        curiositieTitle: 'Forte das Cinco Pontas',
        curiositiesPlace: 'Recife - Pernambuco', 
        curiositieDesc: 'O forte, construido pelos holandeses em 1630, após uma dura batalha em 1654 perdeu uma das suas pontas pelos canhões das naus da Coroa de Portugal, assim portugueses assumiram o forte, que em 1684 foi reconstruido com apenas 4 pontas. Hoje, o forte é sede do Museu da Cidade do Recife', 
        curiositiesSrc:'src/assets/CuriositiesImgs/Pernambuco.jpg'
      },
      ...
      {id:25, 
        ...
        x:430, 
        y:175,
        src:"/src/assets/pins/Alagoas.png",  
        ...
        curiositieTitle: 'Museu Théo Brandão',
        curiositiesPlace: 'Maceió - Alagoas', 
        curiositieDesc: 'Criado em 1975, recebeu o nome de Théo Brabdão por ter sido criado para abrigar a coleção de arte popular que o professor e folclorista Théo Brandão doou à Universidade Federal de Alagoas. Nele pode-se encontrar fitas com gravações de músicas regionais, cantoria de viola, emboladas, folguedos, disco sobre o mesmo tema bem como slides e fotografias. Além disso, tem uma sessão com filmes super 8mm e 16mm sobre manifestações folclóricas de Alagoas. Conta também com produções de artistas alagoanos, como quadros, esculturas, troncos de arvores nacionais e artesanato local.', 
        curiositiesSrc:'src/assets/CuriositiesImgs/Alagoas.jpg'
      },
      ...
      {id:25, 
        ...
        x:380, 
        y:180, 
        src:"/src/assets/pins/Sergipe.png", 
        ...
        curiositieTitle: 'Farol da Farolândia',
        curiositiesPlace: 'Aracaju - Sergipe ', 
        curiositieDesc: 'O primeiro farol de Aracaju, inaugurado em 1861 trazido da França, com 35 metros de altura, consiste numa torre metálica de forma trocônica sob esteios de rosca, tendo base a casa dos faroleitos e no cume um aparelho lenticular que utilizava o querosene como fonte de energia. A sua luz era vista a 17 mihas da costa em tempo claro. Esse farol foi desativado em 16 de julho em 1991, quando foi aceso o novo farol de Aracaju na coroa do Meio.', 
        curiositiesSrc:'src/assets/CuriositiesImgs/Sergipe.jpg'
      },
    ],
