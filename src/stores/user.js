  ...
  state: () => ({
    ...
    states:[
      ...
      {id:2, 
        ...
        curiositieDesc: 'Localizado na Praça Centro Cívico em Boa vista, foi construido em homenagem aos garimpeiros da região que desempenhavam a principal atividade económica do estado durante muitos anos, o que marcou a história de Roraima.', 
      ...
      {id:4, 
        ...
        curiositieDesc: 'Com uma posição estratégica na desembocadura do Amazonas, este lugar era onde os produtos com destinos aos mercados locais e internacionais, a carne com preço baixo e o ponto de chegada de produtos europeus tinham presença, então em 1625, os portugueses instalaram o posto fiscal comercial Casa de Haver o Peso para o controle de peso e arrecadação de tributos dos generos, onde hoje se encontra o Mercado Ver-o-Peso', 
      ...
      {id:6, 
        ...
        curiositieDesc: "As caixas d'água foram inauguradas em 1912, projetadas e construídas pela Chicago Bridge & Iron Works, de Chicago, e vieram dos Estados Unidos para servirem as obras de Ferro Maderia Mamoré. Têm a capacidade de 200.000 litros cada e serviram para abastecer a cidade até o ano 1957, funcionando por ação da gravidade.", 
      ...
      {id:12, 
        ...
        curiositieDesc: 'A Terceira Ponte é a quinta maior ponte em extensão do Brasil. Foi contruída para desafogar as duas primeiras pontes. Possui 3,33 km de extensão, vão principal com 70 m de altura e 260 m de um pilar para o outro, permitindo assim o acesso de navios de grande porte a baía de Vitória, e liga Vitória com Vila Velha e o litoral do Espirito Santo.', 
      ...
      {id:14, 
        ...
        curiositieDesc: 'Inaugurado em 1991, presta homenagem a urbanista Francisca Maria Garfunkel Rischbieter, uma das pioneiras no trabalho de planejamento urbano capital paranaese. Possui uma área total de 278 mil metros quadrados incluindo o bosque com mata atlântica preservada. Dentro do jardim pode ter acesso as seguintes atrações: Estufa, Espaço Cultural Frans Krajcberg, Museu Botânico e Jardim das Sensações.', 
      ...
      {id:15, 
        ...
        curiositieDesc: 'Inaugurada em 1926, é a maior ponte suspensa do Brasil, com 821 metros sendo a maior ponte pênsil sustentada por um sistema de barras olhal ainda existente, possui o 132° vão suspenso do mundo, com 339 metros. E teve como objetivo ligar a Florianópolis com São José, visando substituir o antigo serviço de ligação por balsas, reforçando a importância da cidade como capital.', 
      ...
      {id:18, 
        ...
        curiositieDesc: ' Foi inaugurado em 1816, o segundo teatro mais antigo do Brasil, inicialmente foi chamado de Teatro União, em homenagem a criação do Reino Unido de Portugal Brasil e Algarves, e só em 1920 ganhou o nome de Arthur Azevedo em homenagem ao grande dramaturgo maranhense Artur de Azevedo. O local serviu de berço para a atriz maranhense Apolônia Pinto, em 1854, filha de uma atriz portuguesa que entrou em trabalho de parto pleno teatro, no Camarim n°1. A atriz foi homenageada com duas placas no Camarim n° 1, um busto em bronze, e seus restos mortais estão guardados no teatro', 
      ...
      {id:25, 
        ...
        curiositieDesc: 'O primeiro farol de Aracaju, inaugurado em 1861 trazido da França, com 35 metros de altura, consiste numa torre metálica de forma trocônica sob esteios de rosca, tendo base a casa dos faroleiros e no cume um aparelho lenticular que utilizava o querosene como fonte de energia. A sua luz era vista a 17 mihas da costa em tempo claro. Esse farol foi desativado em 16 de julho em 1991, quando foi aceso o novo farol de Aracaju na coroa do Meio.', 
